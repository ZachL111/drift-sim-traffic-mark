"""Regression checks for the drift-sim-traffic-mark casebook."""
...
from casebook.harness import assert_expected, drift_sim_traffic_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_sim_traffic_mark_summary(), assert_expected())
