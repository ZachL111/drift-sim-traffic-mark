...
$repo = "drift-sim-traffic-mark"
$language = "C#"
$category = "Simulations"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/drift-sim-traffic-walkthrough.md")) {
