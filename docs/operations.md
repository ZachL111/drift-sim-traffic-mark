...
`drift-sim-traffic-mark` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for traffic workflows, centered on protocol validation, framed sample traffic, and bounds and ordering tests.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
